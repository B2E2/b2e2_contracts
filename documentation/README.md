...
Die Entscheidung für die ERC 725 und 735 Standards sowie die Ausgestaltung der Repräsentation von Identitäten insgesamt sind under Anderem von den Kernzielen der [W3C Decentralized
...
Behauptung des “Issuers”, dessen Address um selbige zu überprüfen sowie das verwendete
Signaturschema. Desweiteren beinhaltet ein Claim ein Gültigkeitszeitraum und, im Fall von Anlagen, die ID der realen Anlage, die sog. "Real World Plant ID". Die folgende Tabelle beinhaltet eine Übersicht all, all, alleyyr Claims.
...
| Identity Contract Factory Claim   | Market Authority                    | Market Authority                    | Market Authority veröffentlicht die Address der Identity Contract Factory.                                                                      |
| Energy Token Contract Claim       | Market Authority                    | Market Authority                    | Market Authority veröffentlicht die Address des Energy Token Contracts.                                                                         |
...
Bilanzzeitraum zu verkaufen. Dafür verschickt er under Zustimmung des Verbrauchers 100
...
| Token Contract| Ein Smart Contract, welcher jeder Address einen oder mehrere Kontostände von Token Arten zuweist und eine Menge von Funktionen zum Erstellen und Transferieren von einer oder mehreren Token Arten bereitstellt. 
